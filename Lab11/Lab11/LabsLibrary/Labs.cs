    ...
    public class Labs
    {
        ...
        public class Lab1
        {
            ...
            public string Test()
            {
                ...
                return RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab1 -t:Test");
            }
            public string Run(string inputFile, string outputFile)
            {
                ...
                string output = RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab1 -t:Run");
        ...
        public class Lab2
        {
            public string Build()
            {
                ...
                return RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab2 -t:Build");
            }
            public string Test()
            {
                Console.WriteLine("Testing Lab2...");
                return RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab2 -t:Test");
            }
            public string Run(string inputFile, string outputFile)
            {
                ...
                string output = RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab2 -t:Run");
        ...
        public class Lab3
        {
            public string Build()
            {
                ...
                return RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab3 -t:Build");
            }
            public string Test()
            {
                Console.WriteLine("Testing Lab3...");
                return RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab3 -t:Test");
            }
            public string Run(string inputFile, string outputFile)
            {
                ...
                string output = RunCommand("dotnet build ../../../../Build.proj -p:Solution=Lab3 -t:Run");
