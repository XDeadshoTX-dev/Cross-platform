    ...
    public class BookingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vehicle>().HasData(
               ...
               new Vehicle { reg_number = "DEF4567890", manufacturer_code = "MERCEDES", model_code = "MOD234", vehicle_category_code = "SEDAN", current_mileage = 15000, daily_hire_rate = 80.00M, date_mot_due = new DateTime(2025, 1, 10) },
               new Vehicle { reg_number = "GHI9876543", manufacturer_code = "AUDI", model_code = "MOD567", vehicle_category_code = "SUV", current_mileage = 25000, daily_hire_rate = 85.00M, date_mot_due = new DateTime(2025, 6, 1) },
            ...
            modelBuilder.Entity<Booking>().HasData(
                ...
                new Booking { booking_id = 3, booking_status_code = "RNT", customer_id = 3, reg_number = "JKL1237890", date_from = new DateTime(2024, 11, 10), date_to = new DateTime(2024, 11, 17), confirmation_letter_sent_yn = "Y", payment_received_yn = "Y" },
                new Booking { booking_id = 4, booking_status_code = "CNL", customer_id = 4, reg_number = "MNO4561234", date_from = new DateTime(2024, 10, 1), date_to = new DateTime(2024, 10, 5), confirmation_letter_sent_yn = "N", payment_received_yn = "N" },
                new Booking { booking_id = 5, booking_status_code = "PND", customer_id = 5, reg_number = "DEF4567890", date_from = new DateTime(2024, 12, 15), date_to = new DateTime(2024, 12, 20), confirmation_letter_sent_yn = "Y", payment_received_yn = "N" },
                new Booking { booking_id = 6, booking_status_code = "CMP", customer_id = 6, reg_number = "GHI9876543", date_from = new DateTime(2024, 11, 20), date_to = new DateTime(2024, 11, 25), confirmation_letter_sent_yn = "Y", payment_received_yn = "Y" },
                new Booking { booking_id = 7, booking_status_code = "RNT", customer_id = 7, reg_number = "JKL1234567", date_from = new DateTime(2024, 11, 15), date_to = new DateTime(2024, 11, 22), confirmation_letter_sent_yn = "Y", payment_received_yn = "Y" },
                new Booking { booking_id = 8, booking_status_code = "CNL", customer_id = 8, reg_number = "OPQ9876543", date_from = new DateTime(2024, 10, 10), date_to = new DateTime(2024, 10, 12), confirmation_letter_sent_yn = "N", payment_received_yn = "N" },
                new Booking { booking_id = 9, booking_status_code = "PND", customer_id = 9, reg_number = "RST1234567", date_from = new DateTime(2024, 12, 5), date_to = new DateTime(2024, 12, 12), confirmation_letter_sent_yn = "Y", payment_received_yn = "N" },
                new Booking { booking_id = 10, booking_status_code = "CMP", customer_id = 10, reg_number = "UVW9876543", date_from = new DateTime(2024, 11, 25), date_to = new DateTime(2024, 12, 2), confirmation_letter_sent_yn = "Y", payment_received_yn = "Y" }
            );
        }
    }
}
