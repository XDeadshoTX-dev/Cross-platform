    ...
    public class BookingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>().HasData(
                ...
                new Booking { booking_id = 4, booking_status_code = "RNT", customer_id = 4, reg_number = "MNO4561234", date_from = new DateTime(2024, 10, 1), date_to = new DateTime(2024, 10, 5), confirmation_letter_sent_yn = "N", payment_received_yn = "N" },
